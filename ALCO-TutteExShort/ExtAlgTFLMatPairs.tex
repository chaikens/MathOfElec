...
\section{Discussion}
A pseudo-form\cite{Frankel} is an orientation dependent form $\phi_\epsilon$ (that is, a
...
parallelopiped spanned by $B$ given by the formula $\epsilon(B)\Delta_e(B)$.
