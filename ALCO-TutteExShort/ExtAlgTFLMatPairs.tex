...
Here we show:  $\ext{L}_E$ is a an evaluation of a common generalization
of parametrized Tutte polynomials, relative Tutte polynomials and linking
(matroid pair Tutte) polynomials.  This Tutte polynomial has matroid
variables, and the ones that appear in the polynomial for a given
pair of matroids are minors of those matroids.  However, when the
matroid minors are replaced by exterior algebra minors, the Tutte
equations fail to be satisfied.  The only situation where
the Tutte equations are satisfied is when the corank and nullity
