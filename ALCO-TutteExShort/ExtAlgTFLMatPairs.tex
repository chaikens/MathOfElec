...
\begin{defi}
  ...
  \]
  where $\ext{J}$ is the sum of terms none of which is a product of $\ext{E}=\ext{e_1}\wedge\ext{e_2}\cdots\wedge\ext{e_n}$, when $\ext{L}$ is expanded using the basis generated by $P_\alpha \dunion P_\beta \dunion E$.
\end{defi}
