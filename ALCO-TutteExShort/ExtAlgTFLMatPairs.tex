...
The following definition combines those given by Las Vergnas for the ``big'' Tutte polynomial of
set-pointed matroids, which has matroid variables,
Bollobas and Riordan for ``colored'' Tutte polynomials, which we call parametrized, and
Welsh and Kayibi for the linking polynomial of a matroid pair.     
...
$\ext{N}\alpha = \ext{e_1} - \ext{e}_2$, which are unimodular matroid representation.
It also fails for
