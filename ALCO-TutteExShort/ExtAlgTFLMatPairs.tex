...
\begin{prop}
  ...
  \begin{equation}\label{commutewedgeperp}
    ...
    \epsilon(S^{(1)})\epsilon(S^{(2)})\epsilon(S^{(1)}S^{(2)})(-1)^{r{\Nsup{1}} r\NsupPerp{2}}
...
\begin{equation}
  ...
  \epsilon(S^{(1)})\epsilon(S^{(2)})\epsilon(S^{(1)}S^{(2)})(-1)^{r{\Nsup{1}_\beta} r\NsupPerp{2}\beta}
  \\
  =& 
  (-1)^{r(\ext{N}_\alpha^{(2)})r({\ext{N}_\beta^\perp}^{(1)})}(-1)^{r{\Nsup{1}_\beta} r\NsupPerp{2}\beta}
