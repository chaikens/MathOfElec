...
\[
=
\epsilon(P^1P^2E)\epsilon(P^1P^2E^{1} E^{2})\epsilon(P^1E^1)\epsilon(P^{2}E^2)\epsilon(P^1P^2E^1E^2)
(-1)^{(r\ext{N}^2-|E^2|)(|E^1|)}
\]
...
\]
\[
=\epsilon(PE)\epsilon(PE^{1} E^{2})\epsilon(P^1E^1)\epsilon(P^{2}E^2)\epsilon(P^1E^1P^2E^2)
\]


%\[
%\left(
% (\Is_G(\ext{N}_\alpha^{1}) \wedge \Vs_R({\ext{N}_\beta^{1}}^\perp))/E^1 \wedge
% (\Is_G(\ext{N}_\alpha^{2}) \wedge \Vs_R({\ext{N}_\beta^{2}}^\perp))/E^2
%    \right)
%\]
------------------------------------------------------------------------
