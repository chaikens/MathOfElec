...
The exterior algebras $\bigoplus_{r=0}^{|P_\alpha \dunion P_\beta \dunion E|} \bigwedge^{(r)} KU$,
with distinguished basis $U=P_\alpha \dunion P_\beta \dunion E$
...
exterior algebras for those function domains will be over $K_0$.
...
$P_\alpha \dunion P_\beta \dunion E$.  Since $\ext{v}\wedge\ext{w}=-\ext{w}\wedge\ext{v}$
...
used  defining $\perp$ of $\Nsup{1}$, $\Nsup{2}$ and $\Nsup{1}\wedge\Nsup{2}$ respectively.
