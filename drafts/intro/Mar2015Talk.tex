...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Voltage and Current graphs $N_V$, $N_I$}

\framebox{\begin{minipage}{0.52\textwidth}
``Voltage graph'' $N_V$ (EE\cite{HaslerNeirynck,PathologicalAct}, NOT Gross, ...) represents KVL
$\mathbf{v}\in \text{Cocycles}$ W/ SOME $v_e \equiv 0$
\end{minipage}}
\framebox{
\begin{minipage}{0.4\textwidth}
``Current graph'' $N_I$ represents KCL
