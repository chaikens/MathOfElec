...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Conditions (resistor network det. quantities)}
The \textbf{conditions ...}
are WHAT ORIENTED MINOR is \
...
The Bollobos/Riordan/Zaslavsky, Traldi, Ellis-Monaghan, (sdc unpub)
...
The 2 BRZ conditions on (colors,initial values) $\Rightarrow$ 5;
so does activity theory based on linear order on the non-port-elements.
