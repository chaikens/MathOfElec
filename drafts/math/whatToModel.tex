...
{\bf One-port resistance, current and voltage vector, edge resistance, Laplacian det
...
The derivation of the Bott-Duffin constrained inverse \cite{BottDuffinAlgNetworks}
with $\mathbf{k}^n = V \circ V^\perp$ may be an analog to a 3-way direct sum in
\cite{MR1622290}.
