...
\title{An Exterior Algebra Valued Tutte Function on Linear Matroids or their Pairs}

\author{Seth Chaiken, University at Albany}
...
\block{Summary}{
  ...
  \item
    ...
    \[
    F(M,P) = r_e F(M\setminus e)+ g_e F(M/e)\]
    only when non-loop non-coloop $e\not\in P$.
  \item
    $P$ will play the role of graph vertices.
  \item
    \[
    F \rightarrow
    \]
